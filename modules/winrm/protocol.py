...
from modules.winrm.exceptions import (
    WinRMError,
    WinRMOperationTimeoutError,
    WinRMTransportError,
    WSManFaultError,
)
from modules.winrm.transport import Transport
...
class Protocol(object):
    ...
    def __init__(
        self,
        endpoint: str,
        transport: t.Literal["auto", "basic", "certificate", "ntlm", "kerberos", "credssp", "plaintext", "ssl", "pku2u"] = "plaintext",
